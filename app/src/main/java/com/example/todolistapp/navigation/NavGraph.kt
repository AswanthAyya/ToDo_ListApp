...
fun TodoNavGraph(
    ...
    // Integrating ViewModel -> Main Brain of the App
    val todoViewModel: TodoViewModel = viewModel()

    val todos by todoViewModel.todos.collectAsState()
            // todos is a stateflow (defined in ViewModel)
            // Whenever data changes, screen redraws itself -> recomposition
